...
},{}],"QTTg":[function(require,module,exports) {
"use strict";
...
function myWrite() {
  if (_css.default[a] === "\n") {
    string += "<br>";
  } else if (_css.default[a] === " ") {
    string += "&nbsp";
  } else {
    string += _css.default[a];
  }

  a++;
  write.innerHTML = string;
  style.innerHTML = _css.default.substring(0, a);
  write.scrollTo(0, 9999);

  if (a > _css.default.length - 1) {
...
},{"./css.js":"K4Xi"}]},{},["QTTg"], null)
//# sourceMappingURL=/show.54dc1d0d.js.map